...
update raw.mar2024_ppp_election_county
    set vote_type =
        case
...
-----------------------------------------------------------------------------------------------
create or replace table stage.mar2024_ppp_election_county
as
pivot raw.mar2024_ppp_election_county
on vote_type
using sum(votes);

select *
from stage.mar2024_ppp_election_county;

alter table stage.mar2024_ppp_election_county
...
update stage.mar2024_ppp_election_county
...
-----------------------------------------------------------------------------------------------
create or replace table prod.mar2024_ppp_election_county
as
select *
from stage.mar2024_ppp_election_county
...
select *
from prod.mar2024_ppp_election_county;
